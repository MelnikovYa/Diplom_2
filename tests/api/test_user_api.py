...
class TestUserAPI:
    ...
    @allure.description("Создание пользователя с уже существующим email")
    ...
    @allure.description("Успешный вход под существующим пользователем")
    ...
    @allure.description("Ошибка при входе с неверными логином и паролем")
